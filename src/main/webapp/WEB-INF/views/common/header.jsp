...
<div id="main_header">
	    ...
	    <span id="headerUserID" style="float: right;margin-right: 0.4%;  font-style: initial; font-family: initial; font-size: 13pt; font-weight: inherit;"><%=session.getAttribute("user") %></span> 
</div>
