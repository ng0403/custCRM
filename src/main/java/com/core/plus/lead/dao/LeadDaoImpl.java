	...
	public int leadUploadExcel(MultipartFile excelFile) {
		...
		try {
			...
			for (int i = 1; i < rows; i++) {
				...
				/*
				 * cell = row.getCell(0); if(cell.getCellType() ==
				 * HSSFCell.CELL_TYPE_NUMERIC) {
				 * cell.setCellType(Cell.CELL_TYPE_STRING); lead_no =
				...
				/*
				 * System.out.println("cell? " + cell.toString()); cust_no =
				 * cell.getStringCellValue().trim(); System.out.println( i +
				 * "번째 cust_no ? " + cust_no);
				 ...
				 * if(cell.getCellType() == HSSFCell.CELL_TYPE_NUMERIC) {
				 * 
				 * cell.setCellType(Cell.CELL_TYPE_STRING); cust_name =
				 * cell.getStringCellValue();
				 * 
				...
				/*
				 * cell = row.getCell(3); if(cell.getCellType() ==
				 * HSSFCell.CELL_TYPE_NUMERIC) { int tmp = (int)
				 * cell.getNumericCellValue(); emp_no = String.valueOf(tmp);
				...
				/*
				 * if(cell.getCellType() == HSSFCell.CELL_TYPE_NUMERIC) {
				 * System.out.println("setLead_status_cd enter"); int tmp =
				 * (int) cell.getNumericCellValue(); lead_status_cd =
				 * String.format("%03d", tmp);
				 * 
